...
class BaierlSpider(scrapy.Spider):
    ...
    start_urls = ['http://baierl.com/new-inventory/']
    ...
    def parse(self, response):
        ...
        script_at_page_one = """function main(splash)
                                    assert(splash:go(splash.args.url))
                                    splash:wait(5)
        ...
        script_at_page_two = """function main(splash)
                                    assert(splash:go(splash.args.url))
                                    splash:wait(5)
        ...
        if response.url is not self.start_urls[0]:
            script = script_at_page_two
        else:
            script = script_at_page_one
