...
class EplanningSpider(Spider):
    ...
    def parse_items(self, response):
        ...
        if 'display: inline;  visibility: visible;' in agent_btn:
            ...
            address_head = response.xpath('//tr[th="Address :"]/td/text()').extract()
            address_body = response.xpath('//tr[th="Address :"]/following-sibling::tr/td/text()').extract()
            address = address_head + address_body
            ...
            self.logger.info('Agent button not found on page, passing url')
